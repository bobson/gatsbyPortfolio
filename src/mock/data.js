...
export const projectsData = [
  {
    ...
    title: "CRWN Clothing",
    info: "E-commece web page build with React usig Redux for state managment routing with react-router, firebase for user storage, and stripe for payment, styled with scss.",
    info2: "",
