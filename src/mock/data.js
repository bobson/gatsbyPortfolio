...
export const aboutData = {
  ...
  paragraphTwo:
    "Results-oriented Front-end Developer using React but also other frameworks, leverage analytical skills and strong attention to detail in order to deliver original and efficient web solutions, provide technical knowledge, build new websites from start to finish.",
  paragraphThree: " ",
...
export const projectsData = [
...

  {
    ...
    info2:
      "Built with Semantic HTML5 markup, CSS custom properties, Flexbox, Resposive Mobile workflow, Vite - JS library",
